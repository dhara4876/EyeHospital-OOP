    ...
    private void viewPrescritionPdfBtnOnClick(MouseEvent event) {
        try{
            ...
            if(f!=null){              
                ...
                Text titleText = new Text("Patient Prescription");
                ...
                //adding a list
                Text titleText3 = new Text("Medicines");
                titleText3.setFontSize(18f);
                Paragraph pageTitle3 = new Paragraph(titleText3);
                pageTitle1.setBold();    //OR titleText2.setBold();
                List progLangList = new List();
                progLangList.add("Acetazolamide.");
                progLangList.add("Acetylcysteine.");
                progLangList.add("Aciclovir eye ointment.");
                progLangList.add("Apraclonidine eye drops.");
                progLangList.add("Atropine eye drops.");
                doc.add(lineSpace);
                doc.add(pageTitle3);
                ...
                //adding table in pdf
                float colWidthArr[] = {200f, 100f};
                Table pdfTable = new Table(colWidthArr); 
                
                //adding header row
                
                pdfTable.addCell(new Cell().setBackgroundColor(Color.GRAY).add("Medicine"));
                
                pdfTable.addCell(new Cell().setBackgroundColor(Color.LIGHT_GRAY).add("Dosage"));
                
                //adding content row
                pdfTable.addCell(new Cell().add("Eye Drops"));
                pdfTable.addCell(new Cell().add("2 times a day"));
                
                
                //adding content row
                pdfTable.addCell(new Cell().add("Ointment"));
                pdfTable.addCell(new Cell().add("At bedtime"));
               
                
                //adding content row
                pdfTable.addCell(new Cell().add("Oral Tablets"));
